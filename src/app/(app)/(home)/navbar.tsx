...
const NavbarItems = ({ href, children, isActive }: NavbarItemProps) => {
  return (
    <Button
      ...
      variant="outline"
      className={cn(
        "bg-transparent hover:bg-transparent rounded-[10px] hover:border-primary border-transparent px-3.5 text-lg",
...
const Navbar = () => {
  ...
  return (
    <div>
      <nav className="h-20 flex border-b-4 justify-between font-medium bg-white">
        <Link href="/" className="pl-6 flex items-center">
          <span
            className={cn(
              "text-5xl font-semibold hover:underline",
              poppins.className
            )}
          >
            RE-CON
